...
const data = [
  ...
  },
  {
    ...
    title: "JavaScript",
    links: [
      { href: "unit-3/javascript/notes", text: "Notes", icon: BookOpen },
      { href: "unit-3/javascript/mind-map", text: "Mind Map", icon: Brain },
      { href: "unit-3/javascript/quiz", text: "MCQs", icon: HelpCircle },
      { href: "unit-3/javascript/brief-questions", text: "Brief Questions", icon: FileText },
      { href: "unit-3/javascript/detailed-questions", text: "Detailed Questions", icon: List },
    ],
  },
  {
    id: "5",
    ...
    links: [
      { href: "unit-3/debug-the-code/notes", text: "Notes", icon: BookOpen },
      { href: "unit-3/debug-the-code/mind-map", text: "Mind Map", icon: Brain },
      { href: "unit-3/debug-the-code/quiz", text: "MCQs", icon: HelpCircle },
      { href: "unit-3/debug-the-code/brief-questions", text: "Brief Questions", icon: FileText },
      { href: "unit-3/debug-the-code/detailed-questions", text: "Detailed Questions", icon: List },
    ],
  },
