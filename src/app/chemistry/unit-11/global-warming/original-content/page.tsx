...
const GlobalWarming = () => {
    return (
        <div className="p-6 bg-white text-black">
            ...
            <p className="mb-4">
                <strong>DO YOU KNOW?</strong> Greenhouses are constructed from glass or transparent polymer films. Sunlight can pass through these materials and is used by the plants for photosynthesis.
                The plants radiate some energy in the form of infrared or heat radiations which cannot pass through these materials and is reflected back.
                As a result, the atmosphere inside the greenhouse becomes hot enough to promote plant growth. The temperature inside a greenhouse can be 10°C to 15°C higher than outside.
            </p>
            <p className="mb-4">
            ...
            <h3 className="text-lg font-semibold mb-4">CONCEPT ASSESSMENT EXERCISE 11.5</h3>
            <p className="mb-4">1. Define global warming.</p>
            <p className="mb-4">2. List some effects of global warming.</p>
            <p className="mb-4">3. List some substances that are responsible for global warming.</p>
            <p className="mb-4">4. Establish the link between greenhouse effect and global warming.</p>

            <h3 className="text-lg font-semibold mb-4">Society, Technology and Science</h3>
            <p className="mb-4">
                Incineration is a waste treatment process in which solid waste is burned at high temperature. Incineration consumes all combustible materials, leaving behind ash residue and non-combustible material.
                This process generally reduces the volume of waste by two-thirds, but it is not a clean process. It produces air pollution. It generates considerable smoke and odour.
                This smoke may contain oxides of nitrogen and sulphur.
            </p>
        </div>
    );
};
