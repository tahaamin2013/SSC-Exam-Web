...
const Solution = () => {
    return (
        <div className="p-4">
            <h2 className="text-xl font-bold">2.4 Solution</h2>
            <p>
            ...
            <div className="my-4">
                <p className="font-bold">Solvent + Solute = Solution</p>
                <p className="text-center italic">Fig 2.3: Formation of Solution</p>
            </div>
            <p>
            ...
            <h3 className="text-lg font-semibold mt-4">Solid Solutions</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold mt-4">2.4.3 Unsaturated Solution</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold mt-4">2.4.5 Supersaturated Solution</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold mt-4">Activity 2.1</h3>
            <p>
            ...
            <div className="my-4">
                <p className="font-bold text-center">Unsaturated Solution</p>
                <p className="font-bold text-center">Saturated Solution</p>
                <p className="font-bold text-center">Supersaturated Solution</p>
                <p className="text-center italic">Fig 2.4: Different types of solutions</p>
            </div>

            <h3 className="text-lg font-semibold mt-4">2.4.6 Concentrated and Dilute Solution</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold mt-4">2.4.7 Solubility</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold mt-4">2.4.8 Effect of Temperature on Solubility</h3>
            <p>
                The solubility of solutes depends on temperature. Depending on the nature of the solute, there is either:
            </p>
            <ul className="list-disc list-inside">
                <li>Increase in solubility with temperature e.g., KCl, NH₄Cl</li>
                <li>Decrease in solubility with temperature e.g., Ca(OH)₂</li>
                <li>No change in solubility with temperature e.g., NaCl</li>
            </ul>
        </div>
    );
};
