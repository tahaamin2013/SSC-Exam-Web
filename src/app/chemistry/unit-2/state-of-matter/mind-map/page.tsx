                ...
                <div className="container mx-auto p-8">
                    ...
                    <section className="mb-12 gradient-bg p-8 rounded-lg shadow-lg">
                        ...
                        <p className="text-black mb-4">
                            ...
                            a liquid crystal. It&apos;s  part liquid, part solid. Heat it more, and
                    ...
                    <section className="mb-12">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg mt-6">
                            <h3 className="text-2xl font-semibold text-black mb-4">Liquids</h3>
                            <ul className="list-disc pl-5 text-gray-800">
                                <li>Dense</li>
                    ...
                    <footer className="text-center">
                        <p className="text-gray-800">
                            ...
                            and turns to steam. The tiny bits that make up water don&apos;t change.
                            Just how they move and stick together.
                        </p>
                    </footer>
                </div>
            </section>
