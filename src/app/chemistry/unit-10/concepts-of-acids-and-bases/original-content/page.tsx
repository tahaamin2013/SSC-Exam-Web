...
const Unit10 = () => {
    return (
        <div className="p-6 max-w-4xl mx-auto">
            <h1 className="text-2xl font-bold mb-4">Unit 10. Acids, Bases and Salts</h1>
            ...
            <section className="mb-6">
                <h2 className="text-xl font-semibold mb-2">10.1 Concepts Of Acids And Bases</h2>
                <p className="mb-4">
                ...
                <table className="min-w-full bg-white border border-gray-300 mb-4">
                    <thead>
                        <tr className="border-b">
                            ...
                            <th className="py-2 px-4 text-left">Acid</th>
                    ...
                    <tbody>
                        <tr className="border-b">
                            ...
                            <td className="py-2 px-4">Taste</td>
                            <td className="py-2 px-4">Sour</td>
                            <td className="py-2 px-4">Bitter</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4">2</td>
                            <td className="py-2 px-4">Effect on blue Litmus</td>
                            <td className="py-2 px-4">Turns red</td>
                            <td className="py-2 px-4">No effect</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4">3</td>
                            <td className="py-2 px-4">Effect on red litmus</td>
                            <td className="py-2 px-4">No effect</td>
                            <td className="py-2 px-4">Turns blue</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4">4</td>
                            <td className="py-2 px-4">Effect on skin</td>
                            <td className="py-2 px-4">Corrosive</td>
                            <td className="py-2 px-4">Corrosive</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4">5</td>
                            <td className="py-2 px-4">Electrical conductivity</td>
                            <td className="py-2 px-4">Aqueous solutions conduct electricity</td>
                            <td className="py-2 px-4">Aqueous solutions conduct electricity</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <section className="mb-6">
                <h2 className="text-xl font-semibold mb-2">10.1.1 Arrhenius Concept of Acids and Bases</h2>
                <p className="mb-4">
                ...
                <table className="min-w-full bg-white border border-gray-300 mb-4">
                    <thead>
                        <tr className="border-b">
                            ...
                            <th className="py-2 px-4 text-left">Common use</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr className="border-b">
                            <td className="py-2 px-4">Hydrochloric acid</td>
                            <td className="py-2 px-4">HCl</td>
                            <td className="py-2 px-4">Cleaning of metals, bricks and removing scale from boilers</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4">Nitric acid</td>
                            <td className="py-2 px-4">HNO₃</td>
                            <td className="py-2 px-4">Manufacture of fertilizers, explosives</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4">Sulphuric acid</td>
                            <td className="py-2 px-4">H₂SO₄</td>
                            <td className="py-2 px-4">Manufacture of many chemicals, drugs, dyes, paints and explosives.</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4">Phosphoric acid</td>
                            <td className="py-2 px-4">H₃PO₄</td>
                            <td className="py-2 px-4">Manufacture of fertilizers, acidulant for food</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table className="min-w-full bg-white border border-gray-300">
                    ...
                    <tbody>
                        <tr className="border-b">
                            <td className="py-2 px-4">Sodium hydroxide</td>
                            <td className="py-2 px-4">NaOH</td>
                            <td className="py-2 px-4">Antacid, laxative</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4">Potassium hydroxide</td>
                            <td className="py-2 px-4">KOH</td>
                            <td className="py-2 px-4">Soap making, drain cleaners</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4">Calcium hydroxide</td>
                            <td className="py-2 px-4">Ca(OH)₂</td>
                            <td className="py-2 px-4">Making mortar, plasters, cement</td>
                        </tr>
                        <tr className="border-b">
                            <td className="py-2 px-4">Magnesium hydroxide</td>
                            <td className="py-2 px-4">Mg(OH)₂</td>
                            <td className="py-2 px-4">Making liquid soap, shaving cream</td>
                        </tr>
                    </tbody>
                </table>
            </section>
            ...
            <section className="mb-6">
                <h2 className="text-xl font-semibold mb-2">10.1.2 The Bronsted-Lowery Concept of Acids and Bases</h2>
                <p className="mb-4">
            ...
            <section className="mb-6">
                <h2 className="text-xl font-semibold mb-2">CONCEPT ASSESSMENT EXERCISE 10.1</h2>
                <p className="mb-4">
