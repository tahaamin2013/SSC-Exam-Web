...
const BiochemistryUnit15: React.FC = () => {
  return (
    <div className="p-8">
      ...
      <p className="mb-4">
        Nutrition is the source of food required by living things to stay alive. Our food choices impact our health. Good nutrition forms an important part of a healthy lifestyle. All living organisms are made up of molecules that carry out characteristics of life. The total number of molecules or nutrients that we need is called nutrition or diet.
      </p>

      <h3 className="text-lg font-semibold mb-4">15.1.1 The Importance of Healthy Nutrition/Diet:</h3>
      <ul className="list-disc list-inside mb-4">
        <li>Reduces high blood pressure.</li>
        <li>Lowers high cholesterol.</li>
      </ul>
      <p className="mb-4">
      ...
      <h3 className="text-lg font-semibold mb-4">VERETABLES</h3>
      <p className="mb-4">
        Percentage of Nutrients in Balanced Diet:
      </p>
      <div className="mb-4">
        <img src="/path/to/healthy-diet.png" alt="Healthy Diet" />
        <p className="text-center">Figure 15.1: Healthy Diet</p>
      </div>
      <div className="mb-4">
        <img src="/path/to/nutrients-percentage.png" alt="Percentage of Nutrients in Balanced Diet" />
        <p className="text-center">Figure 15.2: Percentage of Nutrients in Balanced Diet</p>
      </div>
      <p className="mb-4">
        Lipids: 33% <br />
        Carbohydrates: 55% <br />
