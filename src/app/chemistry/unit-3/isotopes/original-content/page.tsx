// pages/isotopes-and-electronic-configuration.tsx

import React from 'react';

const IsotopesAndElectronicConfiguration = () => {
    return (
        <div className="min-h-screen bg-white p-8">
            <div className="container mx-auto bg-gray-50 p-6 rounded-lg shadow-md">
                <h1 className="text-2xl font-bold mb-4">3.5 ISOTOPES</h1>

                <p className="mb-4">
                    Can you identify three similarities and two differences in these atoms? You will find:
                </p>
                <ul className="list-disc list-inside mb-4">
                    <li>(a) Both the atoms have the same number of protons.</li>
                    <li>(b) Both the atoms have the same number of electrons.</li>
                    <li>(c) Both have the same atomic number.</li>
                    <li>(d) Both have different numbers of neutrons.</li>
                ...
                <h2 className="text-xl font-semibold mb-4">Table 3.2 - Comparison of Ordinary Water and Heavy Water</h2>
                <table className="min-w-full bg-gray-100 border border-gray-300 mb-4">
                    <thead>
                        <tr>
                            <th className="py-2 px-4 border-b">Property</th>
                            <th className="py-2 px-4 border-b">Ordinary Water</th>
                            <th className="py-2 px-4 border-b">Heavy Water</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td className="py-2 px-4 border-b">Melting Point</td>
                            <td className="py-2 px-4 border-b">0.00°C</td>
                            <td className="py-2 px-4 border-b">3.81°C</td>
                        </tr>
                        <tr>
                            <td className="py-2 px-4 border-b">Boiling Point</td>
                            <td className="py-2 px-4 border-b">100°C</td>
                            <td className="py-2 px-4 border-b">101.2°C</td>
                        </tr>
                        <tr>
                            <td className="py-2 px-4 border-b">Density at 25°C</td>
                            <td className="py-2 px-4 border-b">0.99701 g/cm³</td>
                            <td className="py-2 px-4 border-b">1.1044 g/cm³</td>
                        </tr>
                    </tbody>
                </table>

                <h2 className="text-xl font-semibold mb-4">3.5.2 Isotopes of Carbon</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mb-4">3.5.3 Isotopes of Chlorine</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mb-4">3.5.4 Isotopes of Uranium</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mb-4">3.5.5 Determination of Relative Atomic Mass</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mb-4">CONCEPT ASSESSMENT EXERCISE 3.1</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mb-4">3.5.6 Uses of Isotopes</h2>
                <p className="mb-4">
                    Stable and radioactive isotopes have many applications in science and medicine. Some of these include:
                </p>
                <ul className="list-disc list-inside mb-4">
                    <li>Radioactive iodine-131 is used as a tracer in diagnosing thyroid problems.</li>
                    <li>Sodium-24 is used to trace the flow of blood and detect possible constrictions or obstructions in the circulatory system.</li>
                    <li>Iodine-123 is used to image the brain.</li>
                    <li>Cobalt-60 is commonly used to irradiate cancer cells in the hope of killing or shrinking tumors.</li>
                    <li>Carbon-14 is used to trace the path of carbon in photosynthesis.</li>
                    <li>Radioactive isotopes are used to determine the molecular structure and study the mechanism of chemical reactions.</li>
                    <li>Radioactive isotopes are used to date rocks, soils, archaeological objects, and mummies.</li>
                </ul>

                <h2 className="text-xl font-semibold mb-4">3.5.7 Carbon Dating</h2>
                <p className="mb-4">
...
export default IsotopesAndElectronicConfiguration;
