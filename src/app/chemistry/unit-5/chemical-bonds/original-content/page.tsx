...
const Unit05_2 = () => {
  return (
    <div className="p-8">
      <h3 className="text-lg font-semibold mt-8">5.2 CHEMICAL BONDS</h3>
      <p className="mt-4">
      ...
      <h4 className="text-md font-semibold mt-8">Electropositive and Electronegative Elements</h4>
      <p className="mt-4">
