...
const questions = [
  ...
  { id: 7, question: "Define acceleration.", answer: "Acceleration is the rate at which an object's velocity changes over time." },
  ...
  { id: 14, question: "How can we say that rest and motion are relative states?", answer: "Rest and motion are relative because they depend on the observer's frame of reference." },
