...
const KinematicsPage: React.FC = () => {
  return (
    <div className="p-6 bg-white text-gray-800">
      <h1 className="text-2xl font-bold mb-4">UNIT 2: KINEMATICS</h1>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-medium mt-4 mb-4">POINT TO PONDER</h3>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">2.1.1 TYPES OF MOTION</h2>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-medium mt-4 mb-2">Translatory motion is further divided into three types</h3>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-4">Types of Motion</h2>
      <ul className="list-disc ml-6 mb-4">
        <li>
          <strong>Translatory motion:</strong> Change in position of a body as a whole. The line or path of motion could be straight, curved, or random. Examples are motion of ball, car, flying birds, airplane, etc.
        </li>
        <li>
          <strong>Rotatory motion:</strong> Rotation of a body around a fixed rotation axis. The particles of the object in rotation move in a circle. Examples are motion of helicopter rotors, blades of fan, etc.
        </li>
        <li>
          <strong>Vibratory motion:</strong> The to and fro motion of an object about its mean position. The object in vibration repeats its motion. Examples are motion of swing, strings of sitar, guitar, etc.
        </li>
      </ul>
      ...
      <ul className="list-disc ml-6 mb-4">
        <li>
          <strong>Rectilinear motion:</strong> Straight line motion. Example is motion of free-falling body.
        </li>
        <li>
          <strong>Curvilinear motion:</strong> Circular or curved path motion. Example is motion of cars around a turn.
        </li>
        <li>
          <strong>Random motion:</strong> Irregular motion. Example is motion of butterfly.
        </li>
      </ul>
      <p className="mb-4">
