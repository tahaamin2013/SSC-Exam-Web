            ...
            <div className="grid grid-cols-1 text-left gap-x-8 w-full">
                <Accordion type="single" collapsible>
                    ...
                    <AccordionItem value="item-2">
                        <AccordionTrigger>
                            1. Explain translatory motion and give examples of various types
                            of translatory motion.
                        </AccordionTrigger>
                        <AccordionContent>
                            <p>
                                Translatory motion is when a body moves in such a way that every
                                point of the body travels the same distance in the same time. It
                                is a type of motion where all parts of the object move in the
                                same direction.
                            </p>
                    ...
                    <AccordionItem value="item-3">
                        ...
                        <AccordionContent>
                            ...
                            <ul>
                                <li>
                                    Distance: The total length covered between two points. It is a
                                    scalar quantity.
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>
                                    Scalar: Physical quantities described only by magnitude (e.g.,
                                    speed, distance).
                                </li>
                                <li>
                    ...
                    <AccordionItem value="item-4">
                        <AccordionTrigger>
                            3. Define the terms speed, velocity, and acceleration.
                        </AccordionTrigger>
                        <AccordionContent>
                            <p>
                            ...
                            <p>
                                <strong>Acceleration:</strong> The rate of change of velocity of
                                a body. Formula: Acceleration = Change in Velocity / Time
                            </p>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-5">
                        ...
                        <AccordionContent>
                            <p>
                                Yes, a body moving at a constant speed can have acceleration if
                                it changes direction. For instance, a body moving in a circular
                                path at constant speed is accelerating due to the change in
                                direction.
                            </p>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-6">
                        <AccordionTrigger>
                            5. How do riders in a Ferris wheel possess translatory motion but
                            not circular motion?
                        </AccordionTrigger>
                        <AccordionContent>
                            <p>
                                Riders on a Ferris wheel are actually in circular motion
                                relative to the wheel, but if you consider their motion relative
                                to a fixed point outside the wheel, they also exhibit
                    ...
                    <AccordionItem value="item-7">
                        <AccordionTrigger>
                            6. Sketch a distance-time graph for a body starting from rest. How
                            will you determine the speed of a body from this graph?
                        </AccordionTrigger>
                        <AccordionContent>
                            <p>
                    ...
                    <AccordionItem value="item-8">
                        <AccordionTrigger>
                            7. What would be the shape of a speed-time graph of a body moving
                            with variable speed?
                        </AccordionTrigger>
                        <AccordionContent>
                            <p>
                                The speed-time graph for a body moving with variable speed is
                                typically zigzag or curved, reflecting the changes in speed over
                                time.
                            </p>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-9">
                        <AccordionTrigger>
                            8. Which of the following can be obtained from the speed-time
                            graph of a body?
                        </AccordionTrigger>
                        <AccordionContent>
                            <ul>
                    ...
                    <AccordionItem value="item-10">
                        ...
                        <AccordionContent>
                            <p>
                                ...
                                line indicates the magnitude, and the direction of the arrowhead
                    ...
                    <AccordionItem value="item-11">
                        ...
                        <AccordionContent>
                            <p>
                                ...
                                because they have both magnitude and direction. The addition or
                                subtraction of vectors involves combining both these components,
                                requiring vector-specific methods such as the parallelogram rule
                                or triangle rule.
                            </p>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-12">
                        ...
                        <AccordionContent>
                            <p>
                                ...
                                physical phenomena accurately. For instance, directions are
                                essential in navigation, and forces must be represented as
                                vectors to understand their effects on objects properly.
                            </p>
                        </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-14">
                        <AccordionTrigger>
                            13. Sketch a velocity-time graph for the motion of the body. From
                            the graph explaining each step, calculate total distance covered
                            by the body.
                        </AccordionTrigger>
                        <AccordionContent>
                            <p>
                                The total distance traveled is the area under the velocity-time
                                graph. For a trapezoid, the area can be calculated using the
