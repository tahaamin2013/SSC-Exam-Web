...
const Page = () => {
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">4.2 MOMENT OF A FORCE</h1>
      <p className="mb-4">
      ...
      <p className="mb-4">
        Why applying force along the hinges does not produce rotation in a door?
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        A Physics teacher was explaining the role of moment arm in torque by performing an experiment. The teacher applied a force of 60 N to open a door. The force is applied at three different points perpendicularly and their distances from the axis of rotation are: (a) d₁ = 0.40 m, (b) d₂ = 0.20 m and (c) d₃ = 0.0 m. Find the torque produced in each case.
      </p>
      <p className="mb-4">
        <strong>GIVEN</strong>
      </p>
      ...
      <p className="mb-4">
        (a). Using the definition of torque τ = d × F
      </p>
      <p className="mb-4">
        Putting values τ = 0.40 m × 60 N
      </p>
      <p className="mb-4">
        Therefore T = 24.0 Nm
      </p>
      ...
      <p className="mb-4">
        (b). Using the definition of torque τ₁ = d × F
      </p>
      <p className="mb-4">
        Putting values τ₁ = 0.20 m × 60 N
      </p>
      <p className="mb-4">
        Therefore T = 12.0 Nm
      </p>
      ...
      <p className="mb-4">
        (c). Using the definition of torque τ = d × F
      </p>
      <p className="mb-4">
        Putting values τ = 0.0 m × 60 N
      </p>
      <p className="mb-4">
        Therefore T = 0 Nm
      </p>
