...
const AtmosphericPressurePage = () => {
    return (
        <div className="p-4">
            ...
            <h2 className="text-lg font-bold">POINT TO PONDER</h2>
            <p className="text-base">
            ...
            <h2 className="text-lg font-bold">5.3.1 MEASUREMENT OF ATMOSPHERIC PRESSURE</h2>
            <p className="text-base">
            ...
            <p className="text-base font-bold">1 atm = 760 torr</p>
            <p className="text-base">
            ...
            <ul className="list-disc list-inside">
                <li className="text-base font-bold">A. Altitude Measurement:</li>
                <p className="text-base">
                ...
                <li className="text-base font-bold">B. Weather Forecasting:</li>
                <p className="text-base">
                ...
                <li className="text-base font-bold">C. Industrial Applications:</li>
                <p className="text-base">
            ...
            <h2 className="text-lg font-bold">5.3.2 ATMOSPHERIC PRESSURE AND HEIGHT FROM SURFACE OF EARTH</h2>
            <p className="text-base">
            ...
            <h2 className="text-lg font-bold">5.3.3 ATMOSPHERIC PRESSURE AND WEATHER</h2>
            <p className="text-base">
            ...
            <h2 className="text-lg font-bold">5.3.4 APPLICATIONS OF ATMOSPHERIC PRESSURE</h2>
            <p className="text-base">
...
export default AtmosphericPressurePage
