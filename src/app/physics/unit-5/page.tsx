...
const data = [
    ...
    },
    {
        ...
        links: [
            { href: "/physics/unit-5/scince-technology-and-engineering/original-content", text: "Original Content", icon: List },
            { href: "/physics/unit-5/scince-technology-and-engineering/notes", text: "Notes", icon: BookOpen },
            { href: "/physics/unit-5/scince-technology-and-engineering/mind-map", text: "Mind Map", icon: Brain },
            { href: "/physics/unit-5/scince-technology-and-engineering/quiz", text: "MCQs", icon: HelpCircle },
            { href: "/physics/unit-5/scince-technology-and-engineering/brief-questions", text: "Brief Questions", icon: FileText },
            { href: "/physics/unit-5/scince-technology-and-engineering/detailed-questions", text: "Detailed Questions", icon: List },
        ],
    },
    {
        id: "5",
