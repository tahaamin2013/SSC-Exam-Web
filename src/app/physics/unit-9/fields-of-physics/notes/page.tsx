                    ...
                    <section className="mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {[
                                ...
                                { name: 'Astronomy', description: 'Study of celestial objects and universe beyond Earth\'s atmosphere. Requires nighttime observation with telescopes' },
                                ...
                                { name: 'Geophysics', description: 'Earth\'s structure and physical phenomena' },
                                { name: 'Climate Physics', description: 'Study of Earth\'s climate' },
