// pages/hypothesis-theory-law.js
import React from 'react';

export default function HypothesisTheoryLaw() {
    return (
        <div className="p-8">
            <h1 className="text-2xl font-bold mb-4">9.3 HYPOTHESIS, THEORY AND LAW</h1>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold mb-2">LAW</h2>
            <p className="mb-4">
