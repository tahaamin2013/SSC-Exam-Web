    ...
    const content: Record<string, JSX.Element> = {
        introduction: (
            <div className="space-y-4">
                <p>Physics relies on measurements of physical quantities. Measuring instruments range from simple (rulers) to complex (AFM, STEM). All instruments have measuring limitations.</p>
            </div>
        ),
        types: (
                        ...
                        <>
                            ...
                            <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                <ul className="list-disc list-inside space-y-2">
                                    <li>Metre rule: 1 meter long, typically divided into 1000 millimeters</li>
                                    <li>Least count of standard metre rule: 1 mm</li>
                                    <li>Measuring tape: Flexible ruler for larger distances
                        ...
                        <>
                            ...
                            <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                <ul className="list-disc list-inside space-y-2">
                                    ...
                                    <li>Least count = Smallest division on main scale / Total divisions on vernier scale</li>
                                    <li>Typical least count: 0.1 mm</li>
                                    <li>Can measure thickness, diameter, and width of objects, including internal and external diameters</li>
                                </ul>
                            </Disclosure.Panel>
                        </>
                    )}
                        ...
                        <>
                            ...
                            <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                <ul className="list-disc list-inside space-y-2">
                                    ...
                                    <li>Key terms:
                                        <ul className="list-disc list-inside ml-4">
                                            <li>Pitch: Distance traveled by circular scale on linear scale in one rotation</li>
                                            <li>Least count = Pitch / Total divisions on circular scale</li>
                                        </ul>
                                    </li>
                ...
                <Disclosure>
                    {({ open }) => (
                        <>
                            ...
                            <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                <ul className="list-disc list-inside space-y-2">
                                    <li>Used to measure volume of liquids, chemicals, or solutions</li>
                                ...
                                <ul className="list-disc list-inside space-y-2">
                                    ...
                                    <li>Types:
                                        <ul className="list-disc list-inside ml-4">
                                            ...
                                            <li>Digital:
                                                <ul className="list-disc list-inside ml-4">
                                                    <li>Controlled by two buttons (start/stop and reset)</li>
                        ...
                        <>
                            ...
                            <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                <ol className="list-decimal list-inside space-y-2">
                                    ...
                                    <li>Add main and circular scale readings for total measurement</li>
                                </ol>
                            </Disclosure.Panel>
                        </>
                    )}
        ...
        concepts: (
            <div className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>Choice between vernier caliper and screw gauge for specific measurements (e.g., page thickness, beaker diameter)</li>
                </ul>
            </div>
        ),
        importance: (
            <div className="space-y-4">
                <ul className="list-disc list-inside space-y-2">
                    <li>Essential for accurate measurements in various experiments and applications</li>
                    <li>Each instrument has specific purposes and limitations</li>
                    <li>Understanding these instruments is crucial for conducting precise scientific investigations</li>
                </ul>
            </div>
        ),
    };
        ...
        <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
                <div className="px-4 py-5 sm:px-6">
                    <h1 className="text-3xl font-bold leading-6 text-gray-900">Measuring Instruments in Physics</h1>
                </div>
