...
const EarthMagneticField: FC = () => {
    return (
        <div className="min-h-screen bg-gray-100 p-6">
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                <h1 className="text-2xl font-bold mb-6">8.5 EARTH'S MAGNETIC FIELD</h1>
                <p>
                ...
                <h2 className="text-xl font-semibold mt-4">SCIENCE TIDBIT'S</h2>
                <p>
                ...
                <h2 className="text-xl font-semibold mt-4">8.5.1 GEOGRAPHICAL AND MAGNETIC POLES OF THE EARTH</h2>
                <p>
                ...
                <h2 className="text-xl font-semibold mt-4">8.5.2 BIO-MAGNETISM</h2>
                <p>
...
export default EarthMagneticField;
