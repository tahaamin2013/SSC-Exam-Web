    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6">
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                ...
                <p>A material which is not a magnet in normal condition can be made a magnet with the help of some techniques and is called induced magnet and this phenomenon is called induced magnetism. Similarly a magnetic material can lose its magnetization.</p>
                <p>There are many ways to make an object an induced magnet or a magnet to lose its magnetization like, by stroking the material with a magnet, by hammering the material in a magnetic field, by heating or by putting the material inside a coil from which direct current is flowing.</p>
                <h2 className="text-xl font-semibold mt-4">STROKING METHOD:</h2>
                <p>This is the way of aligning the poles of a material by a process called stroking for induced magnetism. A permanent magnet is stroked in this process from one end of a bar of some metal to the other end to magnetize it. After rubbing one pole of the magnet on the bar of material from one end to the other then lift the magnet, as shown in figure 8.8.</p>
                ...
                <h2 className="text-xl font-semibold mt-4">FOR YOUR INFORMATION</h2>
                <p>Electric motors used in hand-held hair dryers, electric razors, hair trimmers and many more such devices, work with the help of magnetic force. An electric motor generates magnetic field with electric current through the coil. The magnetic force then causes the movement or spinning that runs the motor.</p>
                <h2 className="text-xl font-semibold mt-4">The magnetic field of a solenoid can mathematically be given as:</h2>
  ...
  = 0.0015 T`}
                ...
                <table className="min-w-full bg-gray-200 mt-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td className="py-2 px-4 border">Made of hard magnetic materials</td>
                            <td className="py-2 px-4 border">Made of soft magnetic materials</td>
                        </tr>
                        <tr>
                            <td className="py-2 px-4 border">Magnetism does not vary in strength</td>
