...
const Page = () => {
  return (
    <div className="bg-white text-black p-8">
      ...
      <p className="text-base font-bold">1J = 1N x 1m</p>
      <p className="text-lg font-bold">SCIENCE TIDBITS</p>
      ...
      <p className="text-lg font-bold">EXAMPLE 6.1: WORK DONE</p>
      <p className="text-base">
      ...
      <p className="text-lg font-bold">Therefore,</p>
      <p className="text-base font-bold">
        W = 20,000 J = 20 kJ
      </p>
